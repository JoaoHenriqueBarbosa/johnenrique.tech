    ...
    <footer className="bg-primary text-primary-foreground py-12 px-6">
      <div className="container max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div className="flex flex-col">
          ...
          <Link href="/" className="hover:underline mb-2" prefetch={false}>
            {t("home")}
          </Link>
          <Link href="/projects" className="hover:underline mb-2" prefetch={false}>
            {t("projects")}
          </Link>
          <Link href="/blog" className="hover:underline mb-2" prefetch={false}>
            {t("blog")}
          </Link>
          <Link href="/privacy-policy" className="hover:underline mb-2" prefetch={false}>
            {t("privacyPolicy")}
          </Link>
